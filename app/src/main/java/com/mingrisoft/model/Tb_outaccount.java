...
public class Tb_outaccount// 支出信息实体类
{
	...
	public Tb_outaccount(int id, String money, String time, String type,
	...
	public String getMoney(){// 设置支出金额的可读属性
		return money;
	}

	public void setMoney(String money){// 设置支出金额的可写属性
		this.money = money;
	}
